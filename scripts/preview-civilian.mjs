...
createServer((req, res) => {
  ...
  if (!military && pathname === '/about') { res.writeHead(302, { Location: '/team' }).end(); return; }
...
}).listen(port, '127.0.0.1', () => console.log(`${military?'Military':'Civilian'} preview: http://127.0.0.1:${port}`));
