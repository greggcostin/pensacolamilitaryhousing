...
export function enhanceSchoolHub(html,data,site){
  if(html.includes('data-costin-style-bundle='))throw Error('Restore editable styles with prepare-civilian-delivery.mjs --restore before rebuilding a school hub; prepare delivery again before publication.');
