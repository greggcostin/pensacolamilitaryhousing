  ...
  return (
    <footer style={{ background: C.ink, borderTop: `1px solid ${C.hairline}`, padding: "64px 32px 40px" }}>
      <div style={{ maxWidth: 1280, margin: "0 auto" }}>
        ...
        <p data-pagefind-ignore className="gc-photo-credit-link" style={{ color: C.mutedD, fontSize: 12, textAlign: "center", marginTop: 18 }}><a href="/photo-credits" data-photography-credits style={{ color: "inherit", textUnderlineOffset: 3 }}>Photography credits</a></p>
