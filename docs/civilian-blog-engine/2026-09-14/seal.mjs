...
const base=import.meta.dirname,source=path.join(base,'source'),report=path.join(source,'docs/civilian-blog-engine/2026-09-14'),preview=path.join(base,'preview'),candidate=path.join(base,'release');
