...
export const QUICK_ANSWERS = {
  ...
  "public/bah-to-mortgage-guide.html": "Lenders count BAH as income and gross it up because it is tax-free, so $1,800 of BAH is treated like about $2,250 of pre-tax pay, and most VA lenders cap debt-to-income at 41% with VA residual-income minimums on top. On this site's affordability model (6.66% rate, zero down, funding fee financed, Escambia County taxes and inland insurance) an E-5 with dependents at NAS Pensacola keeps full PITI inside $1,863 of BAH at roughly $200,000 to $220,000.",
