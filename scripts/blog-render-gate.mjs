...
export function assertBlogRendered(spec,html){
 ...
 if(credit.creditRequired&&(!main.includes('Photo:')||!main.includes(credit.license)))throw Error(spec.slug+': required photo attribution is missing from the rendered article');
