...
// <Pic> renders a <picture> element with AVIF + WebP + original sources
// for any /images/*.jpg|png path. Variants are generated by
// `npm run modern-images`. For non-/images/ srcs (or remote URLs), it
// falls through to a plain <img>. Browsers pick the smallest format
// they support.
const Pic = ({ src, alt = "", loading = "lazy", style, className, ...rest }) => {
  const m = src && /^\/images\/.+\.(jpe?g|png)$/i.exec(src);
  ...
  <Section bg={C.panel}>
    <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit,minmax(320px,1fr))", gap: 64, alignItems: "center" }}>
      ...
      <div className="home-story-grid" style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 8 }}>
        <div>
          <Pic loading="lazy" src={IMG.aboutDeployedCrew} alt="Deployed crew with E-3 AWACS and Canadian flag" style={{ width: "100%", height: 220, objectFit: "cover", objectPosition: "center", display: "block" }} />
        </div>
        <div style={{ background: C.ink }}>
          <Pic loading="lazy" src={IMG.storyOcpSelfie} alt="In OCPs on deployment" style={{ width: "100%", height: 220, objectFit: "contain", objectPosition: "center", display: "block" }} />
        </div>
        <div>
  ...
  <div>
    <section style={{ position: "relative", padding: "200px 32px 80px", background: C.ink }}>
      <div style={{ maxWidth: 1280, margin: "0 auto", display: "grid", gridTemplateColumns: "repeat(auto-fit,minmax(300px,1fr))", gap: 48, alignItems: "center" }}>
        ...
        <div className="about-hero-right" style={{ display: "flex", gap: 16, alignItems: "stretch" }}>
          <Pic className="about-hero-portrait" loading="lazy" src={IMG.navyNoTie} alt="Gregg Costin" style={{ flex: "1 1 auto", maxWidth: 400, height: 480, objectFit: "cover", objectPosition: "center top", display: "block" }} />
    ...
    <Section bg={C.panel}>
      ...
      <div className="about-career-grid" style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit,minmax(240px,1fr))", gap: 8, marginBottom: 40 }}>
        <div className="about-career-wide" style={{ gridColumn: "span 2" }}>
          <Pic loading="lazy" src={IMG.aboutAwacsFlightline} alt="E-3 AWACS on the flightline" style={{ width: "100%", height: 280, objectFit: "cover", objectPosition: "center", display: "block" }} />
          <p style={{ color: C.mutedD, fontSize: 11, marginTop: 6, letterSpacing: 1 }}>E-3 AWACS on the flightline</p>
        </div>
        <div><Pic loading="lazy" src={IMG.aboutFlightsuitAwacs} alt="In flightsuit with E-3 AWACS" style={{ width: "100%", height: 280, objectFit: "cover", display: "block" }} /></div>
        <div><Pic loading="lazy" src={IMG.aboutDeployedCrew} alt="Deployed crew" style={{ width: "100%", height: 280, objectFit: "cover", objectPosition: "center 40%", display: "block" }} /></div>
        <div><Pic loading="lazy" src={IMG.aboutServiceBlues} alt="Service Dress blues" style={{ width: "100%", height: 280, objectFit: "cover", objectPosition: "center 20%", display: "block" }} /></div>
        <div><Pic loading="lazy" src={IMG.aboutPromotion} alt="Promotion ceremony" style={{ width: "100%", height: 220, objectFit: "cover", objectPosition: "center 30%", display: "block" }} /></div>
        <div><Pic loading="lazy" src={IMG.aboutAwacsFoggy} alt="AWACS on a foggy flightline" style={{ width: "100%", height: 220, objectFit: "cover", display: "block" }} /></div>
        <div><Pic loading="lazy" src={IMG.aboutFlightlineOCPs} alt="On the flightline in OCPs" style={{ width: "100%", height: 220, objectFit: "cover", objectPosition: "center top", display: "block" }} /></div>
        <div><Pic loading="lazy" src={IMG.aboutCockpitTanker} alt="In cockpit with KC-135 tanker" style={{ width: "100%", height: 220, objectFit: "cover", display: "block" }} /></div>
        <div className="about-career-mom" style={{ background: C.ink }}><Pic loading="lazy" src={IMG.aboutFlightsuitMom} alt="In flightsuit with mom" style={{ width: "100%", height: 220, objectFit: "contain", objectPosition: "center", display: "block" }} /></div>
      </div>
    ...
    <Section>
      <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit,minmax(300px,1fr))", gap: 48, alignItems: "center" }}>
        <div>
          <Pic className="about-family-img" loading="lazy" src={IMG.kidsCockpit} alt="Family in AWACS cockpit" style={{ width: "100%", height: 360, objectFit: "cover", display: "block" }} />
...
const STARTER_POSTS = [
  {
    slug: "personal-property-activity-pcs-2026",
...
const ReviewsPage = () => {
  ...
  // Real, verbatim Google reviews only — same verified 6-name set as public/reviews.html.
  // Never add invented/persona testimonials here (FTC + Google policy risk).
  const reviews = [
    ...
    { text: "We had an outstanding experience working with Gregg. From the very beginning, he set himself apart by taking the time to meet with us, understand our situation, and tailor his approach specifically to our needs as a military family.", from: "Joshua Slavens", meta: "Verified Google Review" },
    { text: "We were extremely fortunate to meet Gregg by chance during our home search journey. He provided much more than we ever expected from a realtor. As a Veteran I cannot recommend him more highly.", from: "Darin Vazquez", meta: "Verified Google Review" },
    { text: "Greg was a consummate professional and very dedicated to helping us find the best house. We live out of state and Greg went and toured a couple of houses for us and sent us videos.", from: "Julia Mayer", meta: "Verified Google Review" },
        ...
        <div style={{ display: "flex", justifyContent: "center", marginBottom: 24 }}>
          <div style={{ display: "inline-flex", alignItems: "center", gap: 16, background: CHARCOAL, border: `1px solid ${GOLD}`, borderRadius: 14, padding: "20px 30px" }}>
            ...
            <div>
              ...
              <div style={{ color: "#9CA3AF", fontSize: 13, marginTop: 4 }}>49 Google Reviews · Verified on Google Business</div>
            </div>
          </div>
        </div>
        <div style={{ display: "flex", gap: 12, justifyContent: "center", flexWrap: "wrap", marginBottom: 40 }}>
          <BtnP href={GOOGLE_URL}>Read All 49 Reviews on Google</BtnP>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit,minmax(280px,1fr))", gap: 32 }}>
          <div style={{ maxWidth: 420, margin: "0 auto", width: "100%" }}>
            ...
            <div style={{ textAlign: "center", marginBottom: 24 }}>
              <Pic loading="lazy" src={IMG.navyTie} alt="Gregg Costin" style={{ width: 360, height: 360, maxWidth: "100%", borderRadius: "50%", objectFit: "cover", objectPosition: "center -30px", border: `3px solid ${GOLD}44`, display: "block", marginLeft: "auto", marginRight: "auto" }} />
            </div>
