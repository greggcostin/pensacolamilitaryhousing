...
async function start() {
  const response = await fetch('/school-assets/school-finder-data.json');
  ...
  async function initializeMap() {
    ...
    try{
      addStyle('/school-assets/vendor/leaflet/leaflet.css');
      addStyle('/school-assets/vendor/leaflet/markercluster/MarkerCluster.css');
      await loadScript('/school-assets/vendor/leaflet/leaflet.js');
      await loadScript('/school-assets/vendor/leaflet/markercluster/leaflet.markercluster.js');
